...
### Áreas de Foco
Sistemas Distribuídos & Autômatos: Exploração de máquinas de estados e complexidade de algoritmos.
Inteligência Artificial: Desenvolvimento com Perceptrons e integração de GenAI em pipelines de software.
Desenvolvimento Backend: Construção de serviços modulares e integração de APIs.
Infraestrutura Cloud: Experiência com AWS Cloud e ferramentas de IA integradas.

### Stack Técnica
Linguagens: Python (Automação e ML), C++ (Sistemas), PHP e JavaScript (Web).
Fundamentos: Teoria da Computação, Bancos de Dados e Modelagem de Sistemas.
Ferramentas & Ambientes: AWS, Arquiteturas 2.5D para jogos/simulações e versionamento com Git.****

<div style="display: inline_block"><br/>
    <img align="center" alt="html5" src="https://img.shields.io/badge/HTML5-E34F26?style=flat&logo=html5&logoColor=white"/>
    <img align="center" alt="html5" src="https://img.shields.io/badge/CSS-563d7c?&style=flat&logo=css3&logoColor=white"/>
    <img align="center" alt="html5" src="https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white"/>
    <img align="center" alt="html5" src="https://img.shields.io/badge/C%2B%2B-00599C?style=flat&logo=c%2B%2B&logoColor=white"/>
